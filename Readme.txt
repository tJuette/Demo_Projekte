...
"REST-API" (Python-Skript mit PyQt-Benutzeroberfläche)
    ...
    Sichtfenster angezeigt und/oder als JSON-Datei auf der Festplatte gespeichert werden. Daraus kann aber auch 
    eine formatierte XML-Zeichenkette erstellt werden, die sich ebenfalls anzeigen und als wohlgeformtes 
    XML-Dkoument speichern lässt. Aus der XML-Zeichenkette kann eine Tabelle in einer MySQL-Datenbank erstellt 
...
Währungsrechner (Python-Skript mit PyQt-Benutzeroberfläche)
    ...
    angezeigt. Weitere Umrechnungssätze werden nur bei Bedarf einmal heruntergeladen, um den Traffic zu 
    minimieren.
